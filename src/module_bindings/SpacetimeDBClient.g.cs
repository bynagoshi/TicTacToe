    ...
    public sealed class DbConnection : DbConnectionBase<DbConnection, RemoteTables, Reducer>
    {
        ...
        protected override Reducer ToReducer(TransactionUpdate update)
        {
            ...
            return update.ReducerCall.ReducerName switch
            {
                ...
                "JoinGame" => BSATNHelpers.Decode<Reducer.JoinGame>(encodedArgs),
                "MakeMove" => BSATNHelpers.Decode<Reducer.MakeMove>(encodedArgs),
                "ResetGame" => BSATNHelpers.Decode<Reducer.ResetGame>(encodedArgs),
        ...
        protected override bool Dispatch(IReducerEventContext context, Reducer reducer)
        {
            ...
            return reducer switch
            {
                ...
                Reducer.MakeMove args => Reducers.InvokeMakeMove(eventContext, args),
                Reducer.ResetGame args => Reducers.InvokeResetGame(eventContext, args),
